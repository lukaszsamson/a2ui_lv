defmodule A2uiLvWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: A2uiLvWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(A2uiLvWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(A2uiLvWeb.Gettext, "errors", msg, opts)
    end
  end
